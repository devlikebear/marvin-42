...
It links to MOOD, tars, linetta, the blog, and GitHub.
...
The product subdomains (`mood.`, `tars.`) are separate deployments and aren't part of this repo. MOOD (saju, tarot, zodiac; formerly "saju") is served at `mood.marvin-42.com`; `saju.marvin-42.com` may still resolve in parallel.
